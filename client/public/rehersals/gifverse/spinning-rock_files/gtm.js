...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","allowLinker","value","false"],["map","fieldName","page","value",["macro",15]],["map","fieldName","title","value",["macro",16]],["map","fieldName","userId","value",["macro",6]]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
...
return null},Xc=!1;if(F.querySelectorAll)try{var Yc=F.querySelectorAll(":root");Yc&&1==Yc.length&&Yc[0]==F.documentElement&&(Xc=!0)}catch(a){}var Uc=Xc;var ld={},md=null,od=Math.random();ld.s="GTM-P5GCKB";ld.Ob="6a0";ld.Ld="";var pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},qd="www.googletagmanager.com/gtm.js";
var rd=qd,sd=null,td=null,ud=null,vd="//www.googletagmanager.com/a?id="+ld.s+"&cv=56",wd={},xd={},yd=function(){var a=md.sequence||0;md.sequence=a+1;return a};
...
W.a.j=["google"],function(){(function(a){W.__j=a;W.__j.b="j";W.__j.g=!0;W.__j.priorityOverride=0})(function(a){for(var b=String(a.vtp_name).split("."),c=R(b.shift()),d=0;d<b.length;d++)c=c&&c[b[d]];return c})}();
...
W.a.opt=["google"],function(){var a,b=function(c){var d={};if(c.vtp_gaSettings){var e=c.vtp_gaSettings;n(zl(e.vtp_fieldsToSet,"fieldName","value"),d);c.vtp_gaSettings=null;e.vtp_fieldsToSet=void 0;var f=n(e);c=n(c,f)||{}}n(zl(c.vtp_fieldsToSet,"fieldName","value"),d);var h=$g(c.vtp_functionName);if(na(h)){h.r=!0;var k="",l="";c.vtp_setTrackerName&&"string"===typeof c.vtp_trackerName?""!==c.vtp_trackerName&&(l=c.vtp_trackerName,k=l+"."):(l="gtm"+yd(),k=l+".");var m={name:!0,clientId:!0,sampleRate:!0,
...
(A&&m[z]||!A&&void 0===m[z])){var D=p[z]?Ca(y[z]):y[z];"anonymizeIp"!==z||D||(D=void 0);x[z]=D;B++}return B},t={name:l};r(d,t,!0);var q={"&gtm":Jh(!0)};r(d,q,!1);var u=encodeURI(fg("https:","http:","//www.google-analytics.com/"+(c.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js"),!!d.forceSSL));h("create",c.vtp_trackingId,t);h(k+"set",q);h(k+"require",c.vtp_optimizeContainerId,{dataLayer:"dataLayer"});h(c.vtp_gtmOnSuccess);h(k+"require","render");a||(a=!0,K(u,function(){return Yg().loaded||
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var w=R("dataLayer"),v=w&&w.hide;v&&(v.end||!0===v["GTM-P5GCKB"])&&(v[c.vtp_optimizeContainerId]=!0)}else G(c.vtp_gtmOnFailure)};W.__opt=b;W.__opt.b="opt";W.__opt.g=!0;W.__opt.priorityOverride=0}();
...
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var m=dk("fsl",h?"nv.mwt":"mwt",0),p;p=h?dk("fsl","nv.ids",[]):dk("fsl","ids",[]);if(!p.length)return!0;var r=Zj(e,"gtm.formSubmit",p),t=e.action;t&&t.tagName&&(t=e.cloneNode(!1).action);r["gtm.elementUrl"]=t;l&&(r["gtm.formSubmitElement"]=l);if(k&&m){if(!Lk(r,Pj(f),m))return!1}else Lk(r,function(){},m||2E3);return!0}(function(e){W.__fsl=e;W.__fsl.b=
"fsl";W.__fsl.g=!0;W.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var m=function(r){return Math.max(k,r)};ck("fsl","mwt",m,0);h||ck("fsl","nv.mwt",m,0)}var p=function(r){r.push(l);return r};ck("fsl","ids",p,[]);h||ck("fsl","nv.ids",p,[]);Pk("fsl")||(a(),Qk("fsl"));G(e.vtp_gtmOnSuccess)})}();W.a.smm=["google"],function(){(function(a){W.__smm=a;W.__smm.b="smm";W.__smm.g=!0;W.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=zl(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
