...
export default function sketch30perlin2(p) {
    ...
    p.draw = function () {
        ...
        for (let n = 0; n < particles.length; n++) {
            ...
            particles.length > 6 ? particles.splice(0, 1) : console.log(particles.length);
