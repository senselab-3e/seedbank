export default function sketch27(p) {
    ...
    // single values only -- was generating rings with just 0s and 1s 
    ...
    class Letter {
        constructor(msg, x, y, rot, clr, fontSize) {
            ...
            this.rot = rot;
            this.msg = msg;
            this.clr = clr /// this is an object that holds a random value assigned at r, g, b keys - to represent rgb color values later used below
            this.fntsize = fontSize // - use this if you are passing on variable values such as mouseX // /right now it is using static values
        }
